    ...
    customMenu.addEventListener("click", async function (e) {
        ...
        switch (action) {
            ...
            case "trun-left-right": {
                flipfunc.horizontalFlip(editor, selected, start, end);
                break;
            }
            case "trun-upside-down": {
                flipfunc.verticalFlip(editor, selected, start, end);
                break;
            }
            case "trun-right": {
                flipfunc.clockwiseFlip(editor, selected, start, end);
                break;
            }
            case "trun-left": {
                flipfunc.anticlockwiseFlip(editor, selected, start, end);
                break;
            }
            case "trun-180": {
                flipfunc.mirrorFlip(editor, selected, start, end);
                break;
            }
            case "ad-rm-bk": {
                let result = '';
